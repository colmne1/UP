...
namespace ClassConnection
{
    public class Connection
    {
        ...
        public static void Connect()
        {
            try
            {
                string Path = $@"Server=localhost;Database=base1_ISP_21_4_2;User=sa;Password=root";
                    ...
                    case Tables.SocialScholarships:
                        ...
                        while (reader.Read())
                        {
                            SocialScholarships scholarship = new SocialScholarships
                            {
                                ...
                                Files = reader.IsDBNull(6) ? null : (byte[])reader.GetValue(5)
                            };
                    ...
                    case Tables.Statuses_RiskGroup:
                        ...
                        while (reader.Read())
                        {
                            Statuses_RiskGroup riskGroup = new Statuses_RiskGroup
                            {
                                ...
                                Files = reader.IsDBNull(6) ? null : (byte[])reader.GetValue(10)
                            };
                    ...
                    case Tables.Statuses_Invalid:
                        ...
                        while (reader.Read())
                        {
                            Statuses_Invalid invalid = new Statuses_Invalid
                            {
                                ...
                                Files = reader.IsDBNull(6) ? null : (byte[])reader.GetValue(7)
                            };
                    ...
                    case Tables.SPPP_Meetings:
                        ...
                        while (reader.Read())
                        {
                            SPPP_Meetings meeting = new SPPP_Meetings
                            {
                                ...
                                Files = reader.IsDBNull(6) ? null : (byte[])reader.GetValue(9)
                            };
                    ...
                    case Tables.Obshaga:
                        ...
                        while (reader.Read())
                        {
                            Obshaga obshaga = new Obshaga
                            {
                                ...
                                Files = reader.IsDBNull(6) ? null : (byte[])reader.GetValue(6)
                            };
